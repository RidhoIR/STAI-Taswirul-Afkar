...
return new class extends Migration
{
    ...
    {
        Schema::create('honor_proposal_jobs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('honor_proposal_id')->constrained()->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('honor_proposal_tugas');
    }
};
