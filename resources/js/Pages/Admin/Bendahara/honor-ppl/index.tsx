...
import { Anggaran, Honorarium, HonorPPL, HonorProposal, HonorSkripsi, HonorSkripsiTugas, Mahasiswa, PageProps, Transaksi } from '@/types'
...
const Index = ({ honor_ppl }: HonorPplProps) => {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.bendahara.honor-ppl.store'), {
            onSuccess: () => {
                setOpen(false),
                reset(),
                    setData({
                            ...
                            <div className='flex gap-2'>
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        const url = route('admin.bendahara.honor-ppl.laporan', {
                                                        ...
                                                        <div>
                                                            ...
                                                            >
                                                                ...
                                                                <SelectContent>
                                                                    ...
                                                                    <SelectItem value="panitia">Pantia</SelectItem>
                                                                </SelectContent>
                                                            </Select>
                                                        </div>

                                                        {(tugas.jenis_tugas === 'pembimbing') && (
                                                            <>
                                                                <div>
                                                                    <Label>Jumlah</Label>
                                                                    <Input
