...
import { HonorPPL, HonorProposal, HonorSkripsi, PageProps } from '@/types';
import {
...
const Edit = ({ honor_ppl }: HonorPplProps) => {
    ...
    useEffect(() => {
        if (open) {
            setData('semester_id', honor_ppl.semester.id.toString());
            setData('nama', honor_ppl.nama);
            setData('tanggal', honor_ppl.tanggal.toString());
            setData('tugas', honor_ppl.tugas.map((t) => ({
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.bendahara.honor-ppl.update', honor_ppl.id), {
            onSuccess: () => {
                setOpen(false);
                reset();
            }
