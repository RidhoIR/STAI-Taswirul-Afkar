...
import { Anggaran, Honorarium, HonorPPL, HonorProposal, HonorSkripsi, HonorSkripsiTugas, Mahasiswa, Transaksi, User } from "@/types"; // Sesuaikan dengan tipe data Anda
...
export const column: ColumnDef<HonorPPL>[] = [
    {
        id: "no",
        header: "No.",
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const handleDownloadSlip = () => {
                window.open(route('admin.bendahara.honor-ppl.invoice', id), '_blank'); // buka tab baru untuk download PDF
            };
            ...
            return (
                <div className="flex gap-2">
                    ...
                    <Edit honor_ppl={honor_ppl} />
                    <Delete honor_ppl={honor_ppl} />
                </div>
            );
        },
    }
