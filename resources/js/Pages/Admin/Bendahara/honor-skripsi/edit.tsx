...
import { HonorSkripsi, PageProps } from '@/types';
import {
    Select, SelectContent, SelectItem,
    SelectTrigger, SelectValue
} from '@/Components/ui/select';

interface HonorSkripsiProps {
...
const Edit = ({ honor_skripsi }: HonorSkripsiProps) => {
    ...
    useEffect(() => {
        if (open) {
            setData('semester_id', honor_skripsi.semester.id.toString());
            setData('nama', honor_skripsi.nama);
            setData('tanggal', honor_skripsi.tanggal.toString());
            setData('tugas', honor_skripsi.tugas.map((t) => ({
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.bendahara.honor-skripsi.update', honor_skripsi.id), {
            onSuccess: () => {
                setOpen(false);
                reset();
            }
