...
const Index = ({ honor_uas }: HonorUjianProps) => {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.bendahara.honor-ujian.uas.store'), {
            onSuccess: () => {
                setOpen(false),
                    reset(),
                    setData({
