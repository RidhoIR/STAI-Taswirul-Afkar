...
import { column } from './partials/column-tanggungan';
...
interface TanggunganPembayaranProps {
    tanggungan_pembayaran: TanggunganPembayaran[];
    mahasiswa: Mahasiswa;

}

const Index = ({ mahasiswa, tanggungan_pembayaran }: TanggunganPembayaranProps) => {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        post(route('admin.bendahara.mahasiswa.tambah', mahasiswa.id), {
            onSuccess: () => {
                setOpen(false);
    ...
    return (
        <TestLayout>
            ...
            <DataTable data={tanggungan_pembayaran} columns={column} />
        </TestLayout >
    )
}
