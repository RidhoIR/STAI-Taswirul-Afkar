...
import { Anggaran, Honorarium, HonorProposal, HonorSkripsi, HonorSkripsiTugas, Mahasiswa, PageProps, Transaksi } from '@/types'
...
const Index = ({ honor_proposal }: HonorProposalProps) => {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.bendahara.honor-proposal.store'), {
            onSuccess: () => {
                setOpen(false),
                reset(),
                    setData({
                            ...
                            <div className='flex gap-2'>
                                <Button
                                    ...
                                    onClick={() => {
                                        ...
                                        const url = route('admin.bendahara.honor-proposal.laporan', {
