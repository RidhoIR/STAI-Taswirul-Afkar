...
import { Anggaran, Honorarium, HonorProposal, HonorSkripsi, HonorSkripsiTugas, Mahasiswa, Transaksi, User } from "@/types"; // Sesuaikan dengan tipe data Anda
...
export const column: ColumnDef<HonorProposal>[] = [
    {
        id: "no",
        header: "No.",
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            const honor_proposal = row.original;
            ...
            const handleDownloadSlip = () => {
                window.open(route('admin.bendahara.honor-proposal.invoice', id), '_blank'); // buka tab baru untuk download PDF
            };
            ...
            return (
                <div className="flex gap-2">
                    ...
                    <Edit honor_proposal={honor_proposal} />
                    <Delete honor_proposal={honor_proposal} />
                </div>
            );
        },
    }
