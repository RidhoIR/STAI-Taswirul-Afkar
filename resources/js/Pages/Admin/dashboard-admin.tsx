...
import { ArrowDownCircle, ArrowUpCircle, CalendarIcon, CheckCircle, CheckCircle2, CircleDollarSign, CircleUserRound, Clipboard, ClipboardCheck, ClipboardIcon, FileCheck, FilePen, User, XCircle } from "lucide-react"
import {
    Dialog,
    DialogContent,
    DialogFooter,
...
const Index = ({ anggaranCount, anggaranDisetujui, lpjCount, mahasiswaCount }: Props) => {
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                ...
                <Card className="shadow-sm bg-white ">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-xl  font-medium">Mahasiswa</CardTitle>
